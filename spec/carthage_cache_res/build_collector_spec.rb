...
describe CarthageCacheRes::BuildCollector do
  ...
  subject(:collector) { CarthageCacheRes::BuildCollector.new(terminal, build_directory, required_frameworks, executor) }
