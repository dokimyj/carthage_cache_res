...
describe CarthageCacheRes::CartfileResolvedFile do
  ...
  subject(:cartfile_resolved) { CarthageCacheRes::CartfileResolvedFile.new(cartfile_resolved_path, terminal, swift_version_resolver) }
